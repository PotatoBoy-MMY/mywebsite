...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        self.assertNotIn(b'other list item 1', response.content)
        self.assertNotIn(b'other list item 2', response.content)
    ...
    def test_redirects_after_POST_to_existing_list(self):
        other_list = List.objects.create()
        correct_list = List.objects.create()
